...
const Navbar = () => {
    ...
    return (
        ...
        <img /*src={logo}*/ src={require('/Users/friznation/Desktop/projects/uncomplete/web3.0/client/src/images/logo-kryptlow.png')} alt={""} className='w-32 cursor-pointer'></img>
        </div>
